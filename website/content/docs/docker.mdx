...
This pulls `ghcr.io/richar12138/ai-monitor-pro-backend` and `ghcr.io/richar12138/ai-monitor-pro-frontend`. On a fork, set `GHCR_OWNER` to your own namespace. `TT_IMAGE_TAG` selects the tag (default `latest`).
