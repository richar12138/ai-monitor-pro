...
description: Configure how long TokenTelemetry keeps session data, enable durable history, and manage transcript archival.
---
...
![History & Retention settings showing per-agent retention period controls](/screenshots/agent-history-retention.png)
